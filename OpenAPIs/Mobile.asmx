...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/Services/Mobile.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">Mobile</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="Mobile.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="Mobile.asmx?op=AuthUser">AuthUser</a>
              ...
              <li>
                <a href="Mobile.asmx?op=CreateAccount">CreateAccount</a>
              ...
              <li>
                <a href="Mobile.asmx?op=DeleteDevice">DeleteDevice</a>
              ...
              <li>
                <a href="Mobile.asmx?op=GetDevices">GetDevices</a>
              ...
              <li>
                <a href="Mobile.asmx?op=GetEvents">GetEvents</a>
              ...
              <li>
                <a href="Mobile.asmx?op=GetLevelTemplates">GetLevelTemplates</a>
              ...
              <li>
                <a href="Mobile.asmx?op=RegisterDevice">RegisterDevice</a>
              ...
              <li>
                <a href="Mobile.asmx?op=ResendVerificationEmail">ResendVerificationEmail</a>
              ...
              <li>
                <a href="Mobile.asmx?op=UpdateDevice">UpdateDevice</a>
              ...
              <li>
                <a href="Mobile.asmx?op=UpdateEvent">UpdateEvent</a>
              ...
              <li>
                <a href="Mobile.asmx?op=VerifiedAccount">VerifiedAccount</a>
